...
curl -X POST http://localhost:8000/api/recommend `
  ...
  -d "{\"city\":\"上海\",\"skills\":[\"Python\"],\"available_time\":\"每天1-2小时\",\"risk_preference\":\"稳健型\",\"avoid_appearing\":true,\"monthly_goal\":5000}"
```
...
side_hustle_agent/
├── agents/              # 多 Agent 实现
├── core/               # 核心模块 (models, memory, config)
├── knowledge/          # 知识库 (20个副业, 26个城市)
